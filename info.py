...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002030740643')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002030740643')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+wEULR-LArGc3OGY1')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Av_Link_Download/9')
...
URL = "https://karan-e4rb.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://karan-e4rb.onrender.com".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://karan-e4rb.onrender.com".format(FQDN)
else:
    URL = "https://karan-e4rb.onrender.com".format(FQDN)
